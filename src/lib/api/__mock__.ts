...
handlers.push(
  rest.post(`${MOCK_BASE_URL}/token`, (_req, res, ctx) => {
    return res(ctx.status(200), ctx.delay(DELAY_MSEC), ctx.json(tokenResponse));
  })
);
...
handlers.push(
  rest.get(`${MOCK_BASE_URL}/wallet/cash`, (_req, res, ctx) => {
    return res(ctx.status(200), ctx.delay(DELAY_MSEC), ctx.json(walletCashResponse));
  })
);
...
handlers.push(
  rest.get(`${MOCK_BASE_URL}/wallet/margin`, (_req, res, ctx) => {
    return res(ctx.status(200), ctx.delay(DELAY_MSEC), ctx.json(walletMarginResponse));
  })
);
...
handlers.push(
  rest.get(`${MOCK_BASE_URL}/orders`, (req, res, ctx) => {
    return res(
      ctx.status(200),
...
const positionsStockResponse = [
  ...
  },
  {
    ...
    Valuation: 1060.0,
    ProfitLoss: 152.0,
    ProfitLossRate: 16.74008810572687224669603524
  },
  {
    ExecutionID: null,
    AccountType: 4,
    ...
    Valuation: 635.0,
    ProfitLoss: 63.0,
    ProfitLossRate: 11.01398601398601398601398601
  },
  {
    ExecutionID: null,
    AccountType: 4,
    ...
    Valuation: 103500.0,
    ProfitLoss: 1700.0,
    ProfitLossRate: 1.6699410609037328094302554
  },
  {
    ExecutionID: null,
    AccountType: 4,
    ...
    Valuation: 3374.0,
    ProfitLoss: 102.0,
    ProfitLossRate: 3.11735941320293398533007335
  },
  {
    ExecutionID: null,
    AccountType: 4,
    ...
    Valuation: 93500.0,
    ProfitLoss: 2400.0,
    ProfitLossRate: 2.6344676180021953896816685
  },
  {
    ExecutionID: null,
    AccountType: 4,
    ...
    Valuation: 201100.0,
    ProfitLoss: 45100.0,
    ProfitLossRate: 28.91025641025641025641025641
  }
];
...
handlers.push(
  rest.get(`${MOCK_BASE_URL}/positions`, (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.delay(DELAY_MSEC),
